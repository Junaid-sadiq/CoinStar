...
const DebitCardColorSetup = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.topTitle}>Select color option for your card</Text>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("DebitCardColorSetup", { cardColor: selectedColor })}
        >
          <Text
            style={{
              fontSize: 18,
...
export default DebitCardColorSetup;
